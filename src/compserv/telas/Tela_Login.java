...
public class Tela_Login extends javax.swing.JFrame {
    ...
    public void logar(){
        ...
        try {
            ...
            if(rs.next()){
                ...
                Tela_Principal.menCadUser.setEnabled(true);  
    ...
    public Tela_Login() {
        ...
        if(conexao != null){
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/compserv/icones/databaseconected.png")));
        }else{
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/compserv/icones/databaseerror.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/compserv/icones/databaseconected.png"))); // NOI18N
        lblStatus.setText(" ");
